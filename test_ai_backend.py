...
# API Configuration with environment variables and defaults
BASE_URL = os.getenv("AI_BACKEND_BASE_URL", "http://127.0.0.1:8000")
API_PREFIX = os.getenv("AI_BACKEND_API_PREFIX", "/api/ai")
...
def test_products_json_batch():
    ...
    products = load_products_from_json('tests/products.json')
    if not products:
