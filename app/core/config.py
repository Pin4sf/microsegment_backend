...
class Settings(BaseSettings):
    ...
    APP_SECRET_KEY: str  # Used for general encryption purposes, like access tokens in DB
    SESSION_SECRET_KEY: str  # Used specifically for signing session cookies

    # Database URL
    # Example, override in .env
    DATABASE_URL: str = "postgresql+asyncpg://microsegment_user:1234@localhost:5432/microsegment_app_db"
